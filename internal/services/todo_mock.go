...
//
//	mockgen -destination=todo_mock.go -source=todo.go -package=services
//
...
func (m *MockTodoLogic) Create(title, description string) (*known.TodoItem, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoLogic) Update(id int, title, description string, done bool) (*known.TodoItem, error) {
	m.ctrl.T.Helper()
